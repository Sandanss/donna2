...
--
-- Shared with the Node scheduler migration path. This file is intentionally
-- additive and idempotent so either backend migration path can create the
-- dark queue tables before rollout.
