...
EXPECTED_SCENARIO_NAMES = {
    ...
    "consent_grant",
    "consent_decline",
    "consent_ambiguous_then_grant",
    "consent_ai_question_then_grant",
    "consent_off_topic_redirect_decline",
    "consent_boundary_reminder_attempt",
    "discovery",
    "discovery_quiet_routine",
    "discovery_off_topic_weather",
    "discovery_boundary_redirect",
