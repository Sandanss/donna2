...
MAIN_TASK = (
    ...
    "- create_reminder: Save a reminder when the senior themselves asks you to remember "
    "something for them (e.g., \"recordame que el martes tengo cita con el doctor\", "
    "\"remind me to take my pills tomorrow at 8\"). FLOW: (1) repeat back the title and "
    "exact date/time in plain words and ask \"does that sound right?\" — short, ONE turn; "
    "(2) only after they confirm, call the tool with scheduled_time as ISO 8601 in their "
    "local timezone (use Current time from this prompt to resolve relative phrases like "
    "'next Tuesday' or 'tomorrow at 3'); (3) after the tool returns, briefly confirm aloud "
    "(\"Listo, te lo anoté\" / \"Got it, saved that for you\"). Do NOT use this tool for "
    "reminders the family has already set up — only when the senior is asking for a NEW one.\n\n"
