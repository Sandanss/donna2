...
MAIN_TASK = (
    ...
    "- create_reminder: Save a reminder AND auto-schedule the call that will remind them. "
    "Use when the senior asks you to remember something for them (e.g., \"recordame que "
