...
export function encryptSeniorPhi(data = {}) {
  ...
  if (hasOwn(data, 'profileNotes') || hasOwn(data, 'medicalNotes')) {
    const profileNotes = hasOwn(data, 'profileNotes') ? data.profileNotes : data.medicalNotes;
    values.profileNotesEncrypted = encrypt(profileNotes);
    values.profileNotes = null;
    delete values.medicalNotes;
    delete values.medicalNotesEncrypted;
  }
...
export function decryptSeniorPhi(row) {
  ...
  const senior = {
    ...
    profileNotes: encryptedText(row, 'profileNotes', 'profileNotesEncrypted')
      ?? encryptedText(row, 'medicalNotes', 'medicalNotesEncrypted'),
